...
const ListRoot = React.forwardRef<HTMLUListElement, React.HTMLAttributes<HTMLUListElement>>(function ListRoot(
  { className, ...props },
  ref,
) {
  return (
...
const ROW_CLASSNAME =
  "fj:flex fj:w-full fj:items-center fj:gap-3 fj:px-4 fj:py-3 fj:text-[length:var(--fuji-text-base)] fj:text-fuji-foreground";
